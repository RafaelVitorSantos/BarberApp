...
$sql = "SELECT func_id, func_nome, func_cpf, func_email FROM cad_funcionario WHERE func_ativo = 1";
...
<body>
  ...
  <h1 class="text-center mt-3 mb-3">Funcionários</h1>
        ...
        <tr>
          ...
          <td>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item" onclick="return validaDesativar()" href="../src/php/funcionario/desativar.php?id=<?php echo $dados['func_id']; ?>">Desativar</a></li>
            </ul>
          </td>
        </tr>
      <?php } ?>
  ...
  <form method="POST" action="../src/php/funcionario/criar.php" class="modal fade" id="adicionarModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  ?>
  <form method="POST" action="../src/php/funcionario/editar.php" class="modal fade" id="editarModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
