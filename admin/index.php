...
<body>
  ...
  <form method="POST" action="../src/php/admin/login/validateLogin.php" style="border-radius: 5px;" class="container shadow-light d-flex flex-column justify-content-center align-items-center centered w-75 bg-light pt-3 pb-3">
    <img src="page/img/logo_dark.png" style="width: 70%;" alt="Logo Brooklyn Barber Shop">
    <hr class="w-75">
    <p class="mb-0 text-center"><b>Acesse com a sua <span class="text-decoration-underline">conta administrativa!</span></b></p>
